...
public class _02_DataTypes {
 ...
 // модификаторДоступа тип имяПеременной;                 // Объявление без инициализации
 // модификаторДоступа тип имяПеременной = значение;      // Объявление с инициализацией
    // Целочисленные типы
 ...
 // модификаторДоступа Обёртка имяПеременной;             // Объявление ссылки на объект-обёртку
 // модификаторДоступа Обёртка имяПеременной = значение;  // Автоупаковка примитива в обёртку
    ...
    // === КЛЮЧЕВОЕ СЛОВО FINAL (подробнее в _06) ===
 // модификаторДоступа final тип ИМЯ_КОНСТАНТЫ = значение;
    private final double PI = 3.14159;                    // Значение PI теперь неизменно
                                                          // Константы всегда пишутся ЗАГЛАВНЫМИ БУКВАМИ (PI)


    // === КЛЮЧЕВОЕ СЛОВО STATIC (подробнее в _06) ===
 // модификаторДоступа static тип имяСтатическогоПоля;
