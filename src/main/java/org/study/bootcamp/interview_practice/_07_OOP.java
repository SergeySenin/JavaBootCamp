 ...
 * @author Sergey
 */
public class _07_OOP {
/*
    === OOP ===
    Это парадигма программирования, основанная на работе с объектами и их взаимодействием
 */
    ...
    private static void summarizePrinciples() {
        System.out.println("5) Итог по четырём принципам ООП");
