package org.study.bootcamp.mishustin.task31.user.activity.v1.api.cli;

import org.study.bootcamp.mishustin.task31.user.activity.v1.domain.model.ActionType;
import org.study.bootcamp.mishustin.task31.user.activity.v1.domain.model.UserAction;
import org.study.bootcamp.mishustin.task31.user.activity.v1.application.analytics.UserActionAnalyzer;
...
public class Demo {
    public static void main(String[] args) {
        ...
        List<String> topActiveUsers = UserActionAnalyzer.topActiveUsers(actions, 10);
        List<String> topHashtags = UserActionAnalyzer.topPopularHashtags(actions, 5);

        List<String> topCommenters =
                UserActionAnalyzer.topCommentersInRange(actions, 3,
        ...
        System.out.println("Top-3 commenters (Sep–Oct 2024): " + topCommenters);
