 ...
 * @author Sergey
 */
public class Lesson04ControlStructures {
 ...
 */
    ...
    public static void main(String[] args) {
        ...
        Lesson04ControlStructures ifDemoV1 = new Lesson04ControlStructures();
        ...
        Lesson04ControlStructures switchDemoV1 = new Lesson04ControlStructures();
        System.out.println("\n === switch + case (break) ===");
        ...
        Lesson04ControlStructures switchDemoV2 = new Lesson04ControlStructures();
        System.out.println("\n === switch + case (->) ===");
        ...
        Lesson04ControlStructures whileDemoV1 = new Lesson04ControlStructures();
        System.out.println("\n === while ===");
        System.out.println("Демонстрация: цикл с предусловием; тело выполняется только при истинном условии");
        whileDemoV1.countdown(3);

        Lesson04ControlStructures doWhileDemoV1 = new Lesson04ControlStructures();
        System.out.println("\n === do-while ===");
        ...
        Lesson04ControlStructures forV1 = new Lesson04ControlStructures();
        System.out.println("\n === for ===");
        ...
        Lesson04ControlStructures forEachV1 = new Lesson04ControlStructures();
        System.out.println("\n === for + each ===");
        System.out.println("Демонстрация: перебор массива без индекса (for-each)");
        String[] fruits = {"Яблоко", "Банан", "Апельсин"};
        forEachV1.printArrayElements(fruits);

        Lesson04ControlStructures serviceOperatorsV1 = new Lesson04ControlStructures();
        System.out.println("\n === Служебные операторы циклов ===");
